...
public class LoginDAO extends DAO {
    ...
    public boolean obtenerUsuario(Login user) {
/*
        ...
        this.Conectar();
         ...
         ResultSet rs;
        try {
          String sql_ver_existe="select * FROM [SGR].[dbo].[Empleados] where Empleado_Id = '"+user.getUsuario()+"' and Contrasena = CONVERT(VARCHAR(32), HashBytes('MD5', '"+user.getClave()+"'), 2)";
