...
public class DAO3 {
    ...
    private static final String host_server = "172.40.6.21";//172.40.6.21 192.168.0.119
 ...
 /*String usuario     = "USR_MASTER";
    ...
    private static String usuario = "agenda_digital";
    private static String clave = "adf_2023";
    private static String base_datos = "ad_testing";
    //private static String base_datos = "db_afinsol";
    private static int puerto = 5432;
    private String driver = "org.postgresql.Driver";
    private String url = "jdbc:postgresql://"+host_server+":"+puerto+"/" + base_datos;
   ...
   /*Comentado por kevin para pruebas*/
    ...
    public void registrarDriver() throws SQLException {
        Driver posgreDriver = new Driver();
        DriverManager.registerDriver(posgreDriver);
    }
    ...
    public void Conectar() {
        ...
        try {
            ...
            if (connection == null || connection.isClosed() == true) {//System.out.println("Abriendo CONEXION");
                String cadenaConexion = "jdbc:postgresql://"+host_server+":"+puerto+"/" + base_datos;
                registrarDriver();
                connection = DriverManager.getConnection(cadenaConexion, usuario, clave);
                //System.out.println("RC CONECTADO");
            }
        }catch (SQLException e) {
            System.out.println("Error al cerrar la Abrir Con Postgres "+e);
        }
    }
    ...
    public void Cerrar() {
        try {
            ...
            System.out.println("Error al cerrar la conexion Postgres "+e);
        }
